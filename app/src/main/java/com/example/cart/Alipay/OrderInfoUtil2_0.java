...
public class OrderInfoUtil2_0 {
	...
	public static void setPrice(int sum){
		sumPrice=sum;
	}
	public static void setGoodsDetail(List<CartBean> arrayCart){
		for(CartBean cart:arrayCart){
			if(cart.isItem_check()){
				str+=cart.getCart_name()+" "+cart.getCart_count()+";";
			}
		}
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2) {
		...
		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+sumPrice+"\",\"subject\":\"1\",\"body\":\""+str+"\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
